...
sgtitle('Model 1. reda: Estimacija parametara kroz vreme (PRBS)') 
...
sgtitle('Model 2. reda: Estimacija parametara kroz vreme (PRBS)') 
...
for i = 1:length(rhos)
    ...
    disp(['MODEL PRVOG REDA (PRBS, rho = ' num2str(rhos(i)) ')'])
    ...
    disp(['MODEL DRUGOG REDA (PRBS, rho = ' num2str(rhos(i)) ')'])
